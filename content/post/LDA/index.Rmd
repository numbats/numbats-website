...
# save(sent1, file = "data/sent1.rda")  
# save(sent2, file = "data/sent2.rda")  
load("https://numbat.space/post/LDA/data/sent1.rda")
load("https://numbat.space/post/LDA/data/sent2.rda")
...
```{r, make A density plot of the reviews}
...
```{r, LD1 Dimension reduction and Density}
