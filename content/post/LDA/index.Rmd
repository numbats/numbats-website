...
<center>
![](/img/LDA/draw/1dimscaledraw.png)
</center>
...
<center>
![](/img/LDA/draw/1dimbounddraw.png)
</center>
...
```{r, make A density plot of the reviews, eval=FALSE}
...
<center>
![](img/LDA/index_files/figure-html/make A density plot of the reviews-1.png)
</center>
...
<center>  
![](/img/LDA/index_files/figure-html/Find LD1 Values-1.png)
</center>
...
```{r, Animation Data Function, eval=FALSE}
...
```{r, Generate Data Frames, eval=FALSE}
...
<center>
![](/img/LDA/draw/pca_scatter.gif){width=48%} ![](/img/LDA/draw/pca_density.gif){width=48%} 
</center>
...
<center>
![](/img/LDA/draw/nocorr_scatter.gif){width=48%} ![](/img/LDA/draw/nocorr_density.gif){width=48%}
</center>
...
<center>
![](/img/LDA/draw/poscorr_scatter.gif){width=48%} ![](/img/LDA/draw/poscorr_density.gif){width=48%}
</center>
...
<center>
![](/img/LDA/draw/negcorr_scatter.gif){width=48%} ![](/img/LDA/draw/negcorr_density.gif){width=48%}
</center>
...
```{r, Reviews Scatter Plot, eval=FALSE}
...
<center>
![](img/LDA/index_files/figure-html/Reviews Scatter Plot-1.png)
</center>
...
```{r, LD1 Dimension reduction and Density, eval=FALSE}
...
<center>  
![](/img/LDA/index_files/figure-html/LD1 Dimension reduction and Density-1.png)
![](/img/LDA/index_files/figure-html/LD1 Dimension reduction and Density-2.png)
</center>
