...
![*A visualisation of both the guessing and social order of the house. Here, Tom has died of alchohol poisoning.*](/img/regularisation/placingsdraw.png)
...
plot1
ggsave("regularisation/figures/plot1.jpg", plot1, width=10, height=8)
```

![*The house's grades for every semester of uni.*](/img/regularisation/plot1.jpg)
...
plot2 <- ggplot(error_data, aes(x=error, fill=Type, colour=Type)) + 
  ...
  ggtitle("Figure 3")
plot2
ggsave("regularisation/figures/plot2.jpg", plot2, width=10, height=8)
```
...
plot3
ggsave("regularisation/figures/plot3.jpg", plot3, width=10, height=8)
```
...
![*The trainning and test error compared with model complexity.*](/img/regularisation/plot3.jpg)
...
![*Density plots of the training and test error of three linear models that differ in flexibility.*](/img/regularisation/plot2.jpg)
...
contourplot
ggsave("regularisation/figures/contourplot.jpg", contourplot, width=12, height=8) 
```
...
![](/img/regularisation/contourplot.jpg)
![](/img/regularisation/lasso_animation.gif)
...
![*An illustration of the difference between the ridge and laso regression constraints*](/img/regularisation/ridgevslassodraw.PNG)
...
![*An illustration of how the coefficients change as lambda increases.*](/img/regularisation/increasinglambda.PNG)
...
plot4 <- ggplot(cv_df, aes(x=lambda, y=mse, colour=mse)) + 
  ...
  ggtitle("Figure 5")
plot4
ggsave("regularisation/figures/plot4.jpg", plot4, width=10, height=8)
```

![*Selecting our lambda value with the glmnet package's cross validation method.*](/img/regularisation/plot4.jpg)
...
#save plot
ggsave("regularisation/figures/plot6.jpg", plot6, width=10, height=8)
# save data
...
![*This plot shows the impact on our variables of a decreasing lambda (and thus increasing L1 norm).*](/img/regularisation/plot6.jpg)
...
plot7
ggsave("regularisation/figures/plot7.jpg", plot7, width=10, height=8)
```

![*The lasso model coefficients.*](/img/regularisation/plot7.jpg)
...
plot8 <- ggplot(RMSE_data, aes(x=model, colour=model)) + 
  ...
  labs(x="Model", y="RMSE")
plot8
ggsave("regularisation/figures/plot8.jpg", plot8, width=10, height=8)
```
  
![*The RSME of the final lasso model when compared to the previous models over several resamples.*](/img/regularisation/plot8.jpg)
